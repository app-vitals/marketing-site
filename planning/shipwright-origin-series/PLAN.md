...
- `2026-06-11` to `06-12` — migration tooling built: PR #1472 ("Bodhi→Shipwright
  ...
  phased rollout order stated in the commit: **the first agent → `fern-dan` →
...
- `2026-06-16` — `sideby-dan` + `warchild` flipped onto Shipwright; secrets for
  the already-migrated first agent + `fern-dan` dropped.
